...
graphs/rates-eeu.png:	templates/t-plot-rates-eeu country_data/bulgaria  country_data/hungary country_data/slovakia  country_data/poland  country_data/romania  wiki-data/serbia-wiki  country_data/czechrepublic  country_data/greece
	cat populations templates/t-plot-rates-eeu | sed -e "s/DATE/${DATE}/g" | sed -e "s/OFFSET/${OFFSET}/g" | sed -e "s/March/April/g"  > gnuplot/plot-rates-eeu
...
graphs/rates-nordic.png:	templates/t-plot-rates-nordic
	cat populations templates/t-plot-rates-nordic | sed -e "s/DATE/${DATE}/g" | sed -e "s/OFFSET/${OFFSET}/g" | sed -e "s/March/April/g"  > gnuplot/plot-rates-nordic
...
graphs/rates-seasia.png:	templates/t-plot-rates-seasia
	cat populations templates/t-plot-rates-seasia | sed -e "s/DATE/${DATE}/g" | sed -e "s/OFFSET/${OFFSET}/g" | sed -e "s/March/April/g"  > gnuplot/plot-rates-seasia
...
graphs/rates-asia.png:	templates/t-plot-rates-asia
	cat populations templates/t-plot-rates-asia | sed -e "s/DATE/${DATE}/g" | sed -e "s/OFFSET/${OFFSET}/g" | sed -e "s/March/April/g"  > gnuplot/plot-rates-asia
